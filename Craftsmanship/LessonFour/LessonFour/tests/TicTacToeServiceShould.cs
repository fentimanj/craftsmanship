...
public class TicTacToeServiceShould
{
    ...
    [Fact]
    public void ReturnWinnerIsX_WhenGameStarted_GivenXHasDiagonalTopLeftToBottomRight()
    {
        var game = new TicTacToeGame();
    ...
    [Fact]
    public void ReturnWinnerIsO_WhenGameStarted_GivenOHasDiagonalTopLeftToBottomRight()
    {
        var game = new TicTacToeGame();
    ...
    [Fact]
    public void ReturnNextSymbolIsO_WhenGameStarted_GivenOPlaysSameMoveAsX()
    {
        var game = new TicTacToeGame();
